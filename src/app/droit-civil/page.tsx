...
export const metadata: Metadata = {
  title: 'Avocat Droit Civil Maroc',
  description: "Cabinet d'avocat spécialisé en droit civil à Casablanca. Plus de 45 ans d'expérience. Contentieux civil, obligations et contrats.",
};
    ...
    <div className="pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8 text-sm text-muted">
          ...
          <span className="mx-2">›</span>
          <span className="text-foreground">Droit Civil</span>
        </div>

        <div className="grid lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-8">
              Avocat Droit Civil Maroc
            </h1>

            <div className="aspect-[16/9] mb-8 rounded-lg overflow-hidden shadow-lg">
              <img
                src="https://image.jimcdn.com/app/cms/image/transf/dimension=900x10000:format=jpg/path/sd1b0153e8d408d57/image/if13825121aebee84/version/1627556766/avocat-droit-civil-maroc.jpg"
                alt="Avocat droit civil Maroc"
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
              <p>
                Réunissant Le Code des Obligations et des Contrats et le Code de la Famille, le Code Civil est au sein de la vie de tous ceux qui vivent au Maroc et qui y ont ou pas une activité quelconque.
              </p>
              <p>
                Le droit civil est la branche fondamentale du droit privé. Il régit les relations entre les personnes physiques et morales, qu&rsquo;il s&rsquo;agisse de relations familiales, contractuelles, successorales ou de responsabilité civile.
              </p>
              <p>
                Il englobe des matières aussi diverses que le droit des obligations, le droit des contrats, le droit de la responsabilité civile, le droit des biens, le droit des successions et des libéralités.
              </p>
              <p>
                Notre cabinet vous accompagne dans tous vos litiges civils, que ce soit en matière contractuelle, délictuelle ou successorale, et vous assiste devant toutes les juridictions civiles.
              </p>

              <h2 className="text-2xl font-playfair font-semibold text-foreground mt-10">
                Pourquoi faire appel à notre Avocat en droit Civil au Maroc ?
              </h2>
              ...
              <p>
                Ainsi, notre cabinet a su développer son expertise en droit civil et des problèmes qui peuvent se poser par la suite.
              </p>
              <p>
            ...
            <div className="mt-12 text-center">
              ...
              >
                &gt;&gt; Demande de Devis en droit Civil
              </Link>
            </div>
          </div>
