...
export const metadata: Metadata = {
  title: 'Avocat Droit de la Concurrence Maroc',
  description: "Cabinet d'avocat spécialisé en droit de la concurrence à Casablanca. Plus de 45 ans d'expérience. Conseil et contentieux concurrentiel.",
};

export default function DroitDeLaConcurrencePage() {
  return (
    <div className="pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8 text-sm text-muted">
          ...
          <span className="mx-2">›</span>
          <span className="text-foreground">Droit de la Concurrence</span>
        </div>

        <div className="grid lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-8">
              Avocat Droit de la Concurrence Maroc
            </h1>

            <div className="aspect-[16/9] mb-8 rounded-lg overflow-hidden shadow-lg">
              <img
                src="https://image.jimcdn.com/app/cms/image/transf/dimension=900x10000:format=jpg/path/sd1b0153e8d408d57/image/i39e6c26cfba954dc/version/1629893166/avocat-droit-de-la-concurrence-maroc.jpg"
                alt="Avocat droit de la concurrence Maroc"
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
              <p>
                La loi sur la Liberté des Prix et de la Concurrence régit la liberté des prix et aménage la libre concurrence. Elle pose les règles afin, aussi, de protéger les consommateurs.
              </p>
              <p>
                Le droit de la concurrence vise à garantir le libre jeu de la concurrence sur les marchés et à sanctionner les pratiques anticoncurrentielles telles que les ententes illicites, les abus de position dominante, les concentrations économiques excessives et les pratiques restrictives.
              </p>
              <p>
                Il est essentiel pour les entreprises de se conformer à ces règles afin d&rsquo;éviter des sanctions lourdes pouvant aller jusqu&rsquo;à des amendes significatives et des dommages à la réputation.
              </p>
              <p>
                Notre cabinet accompagne les entreprises dans la mise en conformité de leurs pratiques commerciales, les assiste devant le Conseil de la Concurrence et les représente dans les contentieux liés au droit de la concurrence.
              </p>

              <h2 className="text-2xl font-playfair font-semibold text-foreground mt-10">
                Pourquoi faire appel à notre Avocat en droit de la Concurrence au Maroc ?
              </h2>
              ...
              <p>
                Ainsi, notre cabinet a su développer son expertise en droit de la concurrence et des problèmes qui peuvent se poser par la suite.
              </p>
              <p>
            ...
            <div className="mt-12 text-center">
              ...
              >
                &gt;&gt; Demande de Devis en droit de la Concurrence
              </Link>
            </div>
          </div>
