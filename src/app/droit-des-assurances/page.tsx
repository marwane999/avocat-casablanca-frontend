...
export const metadata: Metadata = {
  title: 'Avocat Droit des Assurances Maroc',
  description: "Cabinet d'avocat spécialisé en droit des assurances à Casablanca. Plus de 45 ans d'expérience. Conseil et contentieux en matière d'assurances.",
};
    ...
    <div className="pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8 text-sm text-muted">
          ...
          <span className="mx-2">›</span>
          <span className="text-foreground">Droit des Assurances</span>
        </div>

        <div className="grid lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-8">
              Avocat Droit des Assurances Maroc
            </h1>

            <div className="aspect-[16/9] mb-8 rounded-lg overflow-hidden shadow-lg">
              <img
                src="https://image.jimcdn.com/app/cms/image/transf/dimension=900x10000:format=jpg/path/sd1b0153e8d408d57/image/i19783367db475516/version/1629883515/avocat-droit-des-assurances-maroc.jpg"
                alt="Avocat droit des assurances Maroc"
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
              <p>
                Secteur très important de l&rsquo;économie, l&rsquo;assurance est régie par une pléthore de textes législatifs et règlementaires que les Entreprises ne peuvent appréhender facilement, et surtout, ne peuvent gérer directement sans courir le risque de se léser elles-mêmes.
              </p>
              <p>
                L&rsquo;assurance couvre des domaines aussi variés que l&rsquo;assurance automobile, l&rsquo;assurance habitation, l&rsquo;assurance vie, l&rsquo;assurance maladie, l&rsquo;assurance transport, l&rsquo;assurance crédit, l&rsquo;assurance responsabilité civile et tant d&rsquo;autres branches.
              </p>
              <p>
                Les contrats d&rsquo;assurance sont des contrats d&rsquo;adhésion et il est essentiel pour tout souscripteur de bien comprendre les tenants et aboutissants des clauses qui lui sont proposées avant de s&rsquo;engager. L&rsquo;assistance d&rsquo;un avocat spécialisé est donc vivement recommandée.
              </p>
              <p>
                Notre cabinet vous assiste dans la lecture, la rédaction et la renégociation de vos contrats d&rsquo;assurance, ainsi que dans la gestion de vos sinistres et litiges avec les compagnies d&rsquo;assurance.
              </p>

              <h2 className="text-2xl font-playfair font-semibold text-foreground mt-10">
                Pourquoi faire appel à notre Avocat en droit des Assurances au Maroc ?
              </h2>
              ...
              <p>
                Ainsi, notre cabinet a su développer son expertise en droit des assurances et des problèmes qui peuvent se poser par la suite.
              </p>
              <p>
            ...
            <div className="mt-12 text-center">
              ...
              >
                &gt;&gt; Demande de Devis en droit des Assurances
              </Link>
            </div>
          </div>
