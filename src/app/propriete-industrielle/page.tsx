...
export const metadata: Metadata = {
  title: 'Avocat Propriété Industrielle Maroc',
  description: "Cabinet d'avocat spécialisé en propriété industrielle à Casablanca. Plus de 45 ans d'expérience. Brevets, marques et contentieux de la propriété intellectuelle.",
};

export default function ProprieteIndustriellePage() {
  return (
    <div className="pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8 text-sm text-muted">
          ...
          <span className="mx-2">›</span>
          <span className="text-foreground">Propriété Industrielle</span>
        </div>

        <div className="grid lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-8">
              Avocat Propriété Industrielle Maroc
            </h1>

            <div className="aspect-[16/9] mb-8 rounded-lg overflow-hidden shadow-lg">
              <img
                src="https://image.jimcdn.com/app/cms/image/transf/dimension=900x10000:format=jpg/path/sd1b0153e8d408d57/image/ib512bd72a4e8969d/version/1630691037/avocat-propri%C3%A9t%C3%A9-industrielle-maroc.jpg"
                alt="Avocat propriété industrielle Maroc"
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
              <p>
                La Propriété industrielle couvre principalement des créations techniques, artistiques et distinctives. On y trouve, entre autres, les brevets, les marques, les noms commerciaux, les domaines, les enseignes, les appellations d&rsquo;origine, etc.
              </p>
              <p>
                La protection de la propriété industrielle est essentielle pour les entreprises innovantes qui souhaitent protéger leurs actifs immatériels et conserver un avantage concurrentiel sur le marché.
              </p>
              <p>
                Au Maroc, la propriété industrielle est régie par la loi 17-97 sur la protection de la propriété industrielle, qui transpose les dispositions des conventions internationales auxquelles le Maroc a adhéré.
              </p>
              <p>
                Notre cabinet vous accompagne dans toutes les procédures de dépôt et d&rsquo;enregistrement de vos droits de propriété industrielle, ainsi que dans la défense de ceux-ci en cas de contrefaçon ou d&rsquo;atteinte à vos droits.
              </p>

              <h2 className="text-2xl font-playfair font-semibold text-foreground mt-10">
                Pourquoi faire appel à notre Avocat en Propriété Industrielle au Maroc ?
              </h2>
              ...
              <p>
                Ainsi, notre cabinet a su développer son expertise en propriété industrielle et des problèmes qui peuvent se poser par la suite.
              </p>
              <p>
            ...
            <div className="mt-12 text-center">
              ...
              >
                &gt;&gt; Demande de Devis en Propriété Industrielle
              </Link>
            </div>
          </div>
